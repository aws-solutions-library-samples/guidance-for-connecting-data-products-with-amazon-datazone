...
The dict structures includes a key (not to be modified) per workflow:
    g_manage_project_active: dict - Dict containing properties for managing when a new project is active including:
        g_eventbridge_rule_enabled: bool - If workflow is enabled or not, meaning will execute on event or not.
    g_manage_project_delete: dict - Dict containing properties for managing when a project is going to be deleted including:
        g_eventbridge_rule_enabled: bool - If workflow is enabled or not, meaning will execute on event or not.
