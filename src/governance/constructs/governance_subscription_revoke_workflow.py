...
class GovernanceManageSubscriptionRevokeWorkflowConstruct(Construct):
    ...
    def __init__(self, scope: Construct, construct_id: str, governance_props: dict, workflow_props: dict, common_constructs: dict, env: Environment, **kwargs) -> None:
        ...
        g_manage_subscription_revoke_state_machine_logs = logs.LogGroup(
            scope= self,
            id= 'g_manage_subscription_revoke_state_machine_logs',
            log_group_name=f'/aws/step-functions/{g_manage_subscription_revoke_state_machine_name}',
        ...
        g_manage_subscription_revoke_state_machine = stepfunctions.StateMachine(
            ...
            state_machine_name= g_manage_subscription_revoke_state_machine_name,
            ...
            logs= stepfunctions.LogOptions(
                destination=g_manage_subscription_revoke_state_machine_logs,
        ...
        g_manage_subscription_revoke_rule = events.Rule(
            ...
            event_pattern=events.EventPattern(
                source=['aws.datazone'],
                detail_type=['Subscription Revoked', 'Subscription Cancelled']
            )
        )

        g_manage_subscription_revoke_rule_target = event_targets.LambdaFunction(
