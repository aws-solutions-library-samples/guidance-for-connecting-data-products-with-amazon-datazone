...
class GovernanceManageProjectDeleteWorkflowConstruct(Construct):
    """ Class to represent the workflow that will execute after a Amazon DataZone project is triggered for deletion.
    The workflow will clean project roles' permission boundaries and policies to their original state.
    ...
    def __init__(self, scope: Construct, construct_id: str, governance_props: dict, workflow_props: dict, common_constructs: dict, env: Environment, **kwargs) -> None:
        ...
        # ---------------- Step Functions ------------------------    
        g_manage_project_delete_state_machine = stepfunctions.StateMachine(
            scope= self,
            id= 'g_manage_project_delete_state_machine',
            state_machine_name= 'dz_conn_g_manage_project_delete',
            definition_body=stepfunctions.DefinitionBody.from_file('src/governance/code/stepfunctions/governance_manage_project_delete_workflow.asl.json'),
            definition_substitutions= {
                'region': region,
                'a_clean_project_roles_lambda_name': GLOBAL_VARIABLES['account']['a_clean_project_roles_lambda_name'],
        ...
        g_manage_project_delete_rule = events.Rule(
            scope= self,
            id= 'g_manage_project_delete_rule',
            rule_name= 'dz_conn_g_manage_project_delete_rule',
        ...
        g_manage_project_delete_rule_target = event_targets.SfnStateMachine(
            machine= g_manage_project_delete_state_machine,
        ...
        g_manage_project_delete_rule.add_target(g_manage_project_delete_rule_target)
